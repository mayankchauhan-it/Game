...
# Set the desired zoom factor (less than 1.0 for zooming out)
zoom_factor = 3 
...
while capture.isOpened():
    ...
    # Resize the frame to zoom out the video display
    # resized_frame = cv2.resize(frame, None, fx=zoom_factor, fy=zoom_factor)    

    # Get hand data from the rectangle sub window
    cv2.rectangle(frame, (100, 100), (300, 300), (0, 300, 0), 0)
